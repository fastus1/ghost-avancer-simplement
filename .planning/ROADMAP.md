...
**Goal**: Layout identique a Circle.so — header 64px avec navigation, sidebar 281px pour navigation articles
**Depends on**: Phase 2
**Requirements**: LAYOUT-01 (Header Circle.so), LAYOUT-02 (Sidebar), LAYOUT-03 (Navigation coherente)
**Plans:** 3 plans
**Success Criteria** (what must be TRUE):
...
Plans:
- [ ] 03-01-PLAN.md — Circle.so header partial with navigation links
- [ ] 03-02-PLAN.md — Sidebar with article list and mobile menu
- [ ] 03-03-PLAN.md — CSS Grid layout integration and responsive breakpoints
